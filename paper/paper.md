...
![Organisation of chunked data and json metadata in a typical OME-Zarr 0.4, based on Zarr V2 (figure derived from work by Trevor Manz)](figures/figure2.png)
...
![OME-Zarr 0.5 using the Zarr v3 format. (Figure based on original work by Trevor Manz7)](figures/figure3.png)
...
![Drag & drop interface for OME-Zarrs in FIJI](figures/figure6.png)
